...
class _ManagePlaceState extends State<ManagePlace> {
  ...
  final TextEditingController _nameController =
      TextEditingController(text: "Existing PG/Hostel Name");
  ...
  // Simulated existing property type; default is "PG/Hostel"
  String _selectedPropertyType = "PG/Hostel";

  // Trade certificate status (shown only if property type is PG/Hostel)
  final String _tradeCertificateStatus = "Uploaded";

  List<File> _propertyImages = []; // Simulated existing images (initially empty)
  ...
  void _updatePlace() {
    if (_formKey.currentState!.validate()) {
      ...
      // Further update actions can be added here.
    }
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              // Property Type Selection (editable)
              const Text(
              ...
              // Name Field (label based on property type)
              TextFormField(
              ...
              TextFormField(
                ...
                validator: (value) =>
                    value == null || value.isEmpty ? "Enter rent amount" : null,
              ),
              const SizedBox(height: 16),
              // Conditional: Trade Certificate info (shown only for PG/Hostel)
